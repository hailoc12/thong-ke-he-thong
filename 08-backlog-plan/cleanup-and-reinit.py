#!/usr/bin/env python3
"""
Cleanup and reinitialization script
- Delete all systems (dummy data)
- Delete all non-admin users
- Delete all organizations
- Create fresh organizations from Word document
- Create user accounts from Excel file
"""
...
print('=' * 80)
print('CLEANUP AND REINITIALIZATION')
print('=' * 80)

# Step 1: Delete all systems
system_count = System.objects.count()
System.objects.all().delete()
print(f'✓ Deleted {system_count} systems')
...
# Step 4: Create organizations from Word document list
organizations = [
    'Vụ Bưu chính',
...
# Step 5: Create users from Excel list
users_to_create = [
...
print('\n✅ Cleanup and reinitialization complete!')