...
1. **Tab Reorganization - Assessment:**
   > "Đánh giá thành 1 mục (tab) riêng em nhé. Hiện đang bị để trong An toàn thông tin"
   - **Requirement:** "Đánh giá" (Assessment/Evaluation) should be a **separate tab (Tab 9)**, NOT combined with "An toàn thông tin" (Security - Tab 7)
   - **Action:** Create new dedicated tab for technical debt assessment and system evaluation

2. **Tab Reorganization - Infrastructure & Deployment:**
   > "Triển khai & Hạ tầng (P2 Gap Analysis) đang có các field hơi trùng lặp với phần Hạ tầng kỹ thuật, merge vào thành tab Hạ tầng kỹ thuật & tab Triển khai riêng"
   - **Requirement:** Split "Triển khai & Hạ tầng" into two separate tabs:
     - **Tab: "Hạ tầng kỹ thuật"** (Technical Infrastructure) - Servers, storage, network, hardware specs
     - **Tab: "Triển khai"** (Deployment) - Deployment process, CI/CD, release management
   - **Action:** Remove field duplication and clearly separate infrastructure vs deployment concerns
