"""
Django settings for System Report Management project.
...
MIDDLEWARE = [
    ...
    # Request logging for debugging and data recovery
    'apps.systems.middleware.request_logging_middleware.RequestLoggingMiddleware',
]
...
# In production, override with PostgreSQL
if not DEBUG or env('DB_HOST', default='') != '':
    DATABASES['default'] = {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': env('DB_NAME', default='system_reports'),
...
SIMPLE_JWT = {
    ...
    'REFRESH_TOKEN_LIFETIME': timedelta(days=30),  # Match "Remember me for 30 days" promise
}

# API Documentation (drf-spectacular)
SPECTACULAR_SETTINGS = {
    'TITLE': 'Hệ thống Báo cáo Thống kê API',
    'DESCRIPTION': 'API cho hệ thống quản lý thông tin các ứng dụng/hệ thống CNTT',
    'VERSION': '1.0.0',
